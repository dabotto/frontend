var Index = React.createClass({
    ...
    initRefresh(result) {
        ...
        var [positions, rebalance, claimableValue, summary] = result;
        var next = {
            positions,
            rebalance
        };
                            ...
                            {referenceToken ? <div className = "glass-card card-pad">
                                <div className = "card-header">
                                    <div>
                                        ...
                                        <div className = "card-copy">Add more liquidity through your favorite token or decrease your participation.</div>
                                    </div>
                                </div>
